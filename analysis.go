...
func (cli *client) GetUserPortrait(accessToken, begin, end string) (*UserPortrait, error) {
	api := baseURL + apiGetUserPortrait
	return cli.getUserPortrait(accessToken, begin, end, api)
}

func (cli *client) getUserPortrait(accessToken, begin, end, api string) (*UserPortrait, error) {
...
func (cli *client) GetVisitDistribution(accessToken, begin, end string) (*VisitDistribution, error) {
	api := baseURL + apiGetVisitDistribution
	return cli.getVisitDistribution(accessToken, begin, end, api)
}

func (cli *client) getVisitDistribution(accessToken, begin, end, api string) (*VisitDistribution, error) {
...
func (cli *client) GetVisitPage(accessToken, begin, end string) (*VisitPage, error) {
	api := baseURL + apiGetVisitPage
	return cli.getVisitPage(accessToken, begin, end, api)
}

func (cli *client) getVisitPage(accessToken, begin, end, api string) (*VisitPage, error) {
	url, err := tokenAPI(api, accessToken)
	if err != nil {
		return nil, err
	}
...
// begin 开始日期。格式为 yyyymmdd
// end 结束日期，限定查询1天数据，允许设置的最大值为昨日。格式为 yyyymmdd
func (cli *client) GetDailySummary(accessToken, begin, end string) (*DailySummary, error) {
	api := baseURL + apiGetDailySummary
	return cli.getDailySummary(accessToken, begin, end, api)
}

func (cli *client) getDailySummary(accessToken, begin, end, api string) (*DailySummary, error) {
	url, err := tokenAPI(api, accessToken)
	if err != nil {
		return nil, err
	}
